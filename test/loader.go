...
func Loader() (cid string, loader vm.Loader, resolver vm.Resolver, tns tns.MockedTns, simple peer.MockedNode, err error) {
	var backends []vm.Backend
	cid, simple, backends, err = AllBackends(true)
	if err != nil {
		return
	}
