...
import (
	...
	"github.com/taubyte/vm/engines/wasm/wazero/mocks"
...
func TestRuntime(t *testing.T) {
	...
	_, err = instance.Runtime(
		&wasm.HostModuleDefinitions{
			Functions: []*wasm.HostModuleFunctionDefinition{testFunc, testFunc},
		})
	assertError(t, err)
	...
	_, err = instance.Runtime(
		&wasm.HostModuleDefinitions{
			...
			Globals:   []*wasm.HostModuleGlobalDefinition{mockGlobalDef, mockGlobalDef},
		})
	assertError(t, err)
	...
	_, err = instance.Runtime(
		&wasm.HostModuleDefinitions{
			Functions: []*wasm.HostModuleFunctionDefinition{testFunc},
			Memories:  []*wasm.HostModuleMemoryDefinition{mockMemoryDef, mockMemoryDef},
		})
	assertError(t, err)
