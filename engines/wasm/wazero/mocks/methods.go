...
func (m *mockPlugin) New(instance wasm.Instance) (wasm.PluginInstance, error) {
	if instance == nil {
...
func (m *mockPluginInstance) Load(hostModule wasm.HostModule) (wasm.ModuleInstance, error) {
	if hostModule == nil {
...
func (m *mockPluginInstance) LoadFactory(factory wasm.Factory, hm wasm.HostModule) error {
...
func (m *mockModuleInstance) Function(name string) (wasm.FunctionInstance, error) {
	if len(name) == 0 {
...
func (m *mockFunctionInstance) Call(context.Context, ...interface{}) wasm.Return {
	return &mockReturn{}
}
