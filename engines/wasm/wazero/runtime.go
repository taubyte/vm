...
func (r *runtime) Expose(name string) (wasm.HostModule, error) {
	return &hostModule{
		ctx:       r.instance.ctx,
		name:      name,
		runtime:   r,
...
func (r *runtime) Attach(plugin wasm.Plugin) (wasm.PluginInstance, wasm.ModuleInstance, error) {
	if plugin == nil {
...
func (r *runtime) Module(name string) (wasm.ModuleInstance, error) {
...
func (r *runtime) module(name string) (wasm.ModuleInstance, error) {
	...
	if modInst == nil {
		module, err := r.instance.engine.Source().Module(r.instance.ctx, name)
		if err != nil {
...
func (r *runtime) defaultModuleFunctions() []*wasm.HostModuleFunctionDefinition {
	return []*wasm.HostModuleFunctionDefinition{
		{
			Name: "_ready",
			Handler: func(ctx context.Context, module wasm.Module) {
		...
		{
			Name: "_log",
			Handler: func(ctx context.Context, module wasm.Module, data uint32, dataLen uint32) {
