...
import (
	...
	callBridge "github.com/taubyte/vm/engines/wasm/wazero/callBridge"
	api "github.com/tetratelabs/wazero/api"

	wasm "github.com/taubyte/vm/ifaces/wasm"
)

var _ wasm.HostModule = &hostModule{}

var moduleType = reflect.TypeOf((*wasm.Module)(nil)).Elem()
var wazeroModuleType = reflect.TypeOf((*api.Module)(nil)).Elem()

func (hm *hostModule) convertToHandler(def *wasm.HostModuleFunctionDefinition) (interface{}, error) {
...
func (hm *hostModule) Functions(defs ...*wasm.HostModuleFunctionDefinition) (err error) {
...
func (hm *hostModule) memory(def *wasm.HostModuleMemoryDefinition) error {
	if def != nil {
...
func (hm *hostModule) Memories(defs ...*wasm.HostModuleMemoryDefinition) error {
	for _, def := range defs {
...
func (hm *hostModule) global(def *wasm.HostModuleGlobalDefinition) error {
	if def != nil {
...
func (hm *hostModule) Globals(defs ...*wasm.HostModuleGlobalDefinition) error {
	for _, def := range defs {
...
func (hm *hostModule) Compile() (wasm.ModuleInstance, error) {
